...
2a. alc889-84 - Mountain Lion 10.8 - 10.8.4/AppleHDA.kext_v2.3.7
...
Details - audio_ALC889-ver_patch script  (see Requirements)
...
3. Run script
3a. Downloads/audio_ALC889-master/audio_alc889-ver_patch.command
3b. Lunch (double click)
3c. Enter Password when requested

4. Example: Terminal/audio_alc889-85_patch window
_____________________________

...$ .../Downloads/audio_ALC889-master/audio_alc889-85_patch.command ; exit;
...
5a. Terminal/Shell/Export Text As../Terminal Saved Output/Desktop/audio_ALC889
5b. Restart
