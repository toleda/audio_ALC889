...
v2: 8/18/13 - 10.8.4 Shell Script Realtek ALC889 AppleHDA.kext Patching

Requirements
1. Native S/L/E/AppheHDA.kext (restore native AppleHDA.kext with Combo Update)
2. alc889-84 - Mountain Lion 10.8 - 10.8.4/AppleHDA.kext_v2.3.7
...
Three Realtek ALC889 AppleHDA.kext Audio_IDs, select one
...
1. Downloads/audio_ALC889-master/audio_alc889-84_patch.sh
...
audio_alc889-84_patch.sh
README.txt
Files:
889.zip

Details - audio_ALC889-rv-patch script  (see Reqirements)

1. Verify: 
1a. native S/L/E/AppleHDA.kext
1b. Downloads/audio_ALC889-master

2. Rename or Delete (if present)
2a. Desktop/audio-ALC889 to Desktop/audio-ALC889-archive

3. Run script
3a. Downloads/audio_ALC889-master/audio_alc889-84_patch
...
4. Terminal/audio_alc889-84_patch window
_____________________________

Last login: Tue Aug 13 19:43:30 on console
$ . . ./Downloads/audio_ALC889-master/audio_alc889-84_patch.sh ; exit;
...
6a. Install Desktop/audio_ALC889/AppleHDA-orig.kext to S/L/E/AppleHDA.kext
6b. Go to Step 1.
