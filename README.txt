...
This guide enables OS X Realtek ALC889 onboard audio on Intel based motherboards with a bootable clean install of OS X. The Realtek AppleHDA.kext only works with the codec the kext was edited for and replaces the native AppleHDA.kext.
...
Three techniques enable the Realtek ALC889 AppleHDA.kext, select one
...
1. Downloads/audio_ALC889-master/toledaALC889_patch.txt
...
toleda
https://github.com/toleda/audio_toledaALC889
toledaALC889_patch_kit
README.txt
Files:
889.zip
